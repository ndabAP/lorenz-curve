...
var _default = function _default(data) {
  ...
  // Sort data ascending
  var sorted = (0, _sortBy.default)(data); // Data size

  var amount = (0, _size.default)(sorted); // Cummulate the data

  var added = (0, _reduce.default)(sorted, function (cummulated, current, key) {
    // First value is always first value of data
    if (key === 0) {
      cummulated.push((0, _head.default)(sorted));
    } else cummulated.push(current + (0, _last.default)(cummulated));

    return cummulated;
  }, []); // Cummulative result

  var max = (0, _last.default)(added); // Value ratio of data

  var ratios = []; // Ratio regarding max value

  var percentages = [];
  (0, _each.default)(added, function (value, index) {
    percentages.push((0, _round.default)(value / max, precision));
    ratios.push((0, _round.default)((index + 1) / amount, precision));
  });
  return {
    x: ratios,
    y: percentages
